...
INSERT INTO "new_Devis" ("chantierId", "clientId", "createdAt", "dateCreation", "dateValidite", "delaiExecution", "devisParentId", "id", "lot", "maitreOeuvre", "maitreOuvrage", "modaliteReglement", "modelePdf", "numero", "objet", "referenceMarche", "signatureToken", "statut", "totalHT", "totalTTC", "totalTVA", "type", "updatedAt") SELECT "chantierId", "clientId", "createdAt", "dateCreation", "dateValidite", "delaiExecution", "devisParentId", "id", "lot", "maitreOeuvre", "maitreOuvrage", "modaliteReglement", "modelePdf", "numero", "objet", "referenceMarche", "signatureToken", "statut", "totalHT", "totalTTC", "totalTVA", "type", "updatedAt" FROM "Devis";
DROP TABLE "Devis";
