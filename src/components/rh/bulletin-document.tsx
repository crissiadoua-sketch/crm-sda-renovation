...
import type { Salarie, BulletinDePaie, Parametres } from "@/generated/prisma/client";
...
type Mutuelle = {
  formuleMutuelle: { label: string; cotisationSalarie: number; cotisationPatronale: number };
  contratMutuelle: { organisme: string };
} | null;
...
export function BulletinDocument({
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm text-sm print:shadow-none print:border-0">
      {/* En-tête */}
